...
if __name__ == '__main__':
    ...
    assert args.graph in {'ER', 'NWS', 'BA', 'WS'}, 'Unknown Graph Type'
    ...
    for exp_id in range(args.exp_num):
        ...
        elif args.graph in 'WS':
            G = nx.watts_strogatz_graph(n,k,p,seed=exp_id)
        ...
        data_path = 'DF_' + args.graph + str(n) + '_p' + str(args.p) + '_exp' + str(exp_id) +'.pickle'
