...
parser.add_argument('--num-nodes', type=int, default=20, help='Number of nodes, default=10')
...
class CMLDynamicSimulator():
    def __init__(self, batch_size, sz, s):
        ...
        if args.graph=='ER':
            ...
            flag = True
            while flag:
                self.G = nx.random_graphs.erdos_renyi_graph(sz, args.p,seed=3)
